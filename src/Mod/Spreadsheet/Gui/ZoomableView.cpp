    ...
    , stv {ui->cells}
{
    ...
    connect(realSB_h, &QAbstractSlider::valueChanged, this, &ZoomableView::scrollingOccured);
    connect(realSB_v, &QAbstractSlider::valueChanged, this, &ZoomableView::scrollingOccured);
